...
Original file is located at
    https://colab.research.google.com/drive/1AKwTT5ZyEEMohB-1eaqmPGiR7x7qJ90i
"""
...
labels_csv= os.path.join(input_dir,'classes_brindha.txt')
train_csv = os.path.join(input_dir,'train_labels_brindha.txt')
#resnet_weights_path = os.path.join('resnet50.pth')
resnet_weights_path = os.path.join('wide_resnet50_2-95faca4d.pth')
...
resnet_cls = models.wide_resnet50_2(pretrained=True)
#resnet_cls.load_state_dict(torch.load(resnet_weights_path))
...
class ResNet50(nn.Module):
    def __init__(self,num_outputs):
        ...
        self.resnet.fc = nn.Sequential(nn.Dropout(p=0.2),nn.Linear(in_features=self.resnet.fc.in_features, out_features=512),nn.LeakyReLU(0.1),nn.Dropout(p=0.3),nn.Linear(512,num_outputs))
...
torch.save(NeuralNet, "ResNetFoodWide_150.pth")
...
test_df.to_csv('/home/team9/submission_resnet50_150_v2.csv',index = False)
print('Generated')
